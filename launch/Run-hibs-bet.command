...
if [ ! -f ".env" ]; then
  osascript -e 'display dialog "hibs-bet cannot start without a .env file in the app root. Copy .env.example and fill in your API keys." buttons {"OK"} default button "OK"'
  exit 1
fi
