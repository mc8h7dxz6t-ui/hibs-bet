...
## Coverage
- **World Cup focus window** — auto-limits fetch to internationals **2026-06-01 → 2026-07-18** when `HIBS_TOURNAMENT_FOCUS` is unset; domestic outside window. `=0` forces domestic in-window (rare); region chips load domestic via `?domestic=1`.
